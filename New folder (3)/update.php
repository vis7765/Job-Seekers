...
<div class="w3-container" style="padding:100px" align="center" >
  ...
  <h2 align="center">Enter the Data to Update</h2>

<p align="center"><-You cannot change few data-></p>
...
<?php echo '<input type="text" name="fname"  class="form-control" style="width: 260px"  value='.$bag['fname'].'>'; ?>
</td> <td style="width: 50%">
<label for="Last_Name">Last name *</label><br />
<?php echo '<input type="text" name="lname"  class="form-control" style="width: 260px"  value='.$bag['lname'].'>'; ?>
</td> </tr> 
<tr> <td style="width: 50%">
...
<?php echo '<input type="text" name="username"  class="form-control" style="width: 260px"  value='.$bag['mobile'].'>'; ?>
</td></tr>
